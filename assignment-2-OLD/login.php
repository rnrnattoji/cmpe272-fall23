...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err)) {
        ...
        $sql = "SELECT id, name, password FROM usersdummy WHERE name = ?";
...
<body background="online_shopping.jpeg" background-repeat="no-repeat" background-size="cover">
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="index.php">GreenLeaf Elektronics</a>
            </div>
    ...
    <div style="margin-top:60px;color:white;float:right" class="wrapper">
        ...
        <?php
        if (!empty($show_users)) {
            echo '<a href="users.php">Show Users List</a>';
        }
        ?>
