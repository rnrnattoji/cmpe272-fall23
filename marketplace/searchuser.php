...
if (isset($_POST['save'])) {
    if (!empty($_POST['search'])) {
        $search = $_POST['search'];
        $stmt = $link->prepare("select * from users where name like '%$search%' or contact like '%$search%' or homecontact like '%$search%' or email like '%$search%'");
        //$stmt->execute();  
        $sql = "select * from users where name like '%$search%' or contact like '%$search%' or homecontact like '%$search%' or email like '%$search%'";
